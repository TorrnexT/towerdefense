...
## Manager application icon (2026-09-15)

Original raster emblem generated with the built-in image_gen tool, without reference images. The watchtower and ember flame use Emberwatch’s dark green and gold palette. The generated square image was exported to 124 × 124 pixels as an 8-bit RGBA PNG and validated through the Manager’s EntityIconService. The application asset is `.monitoring/icon.png` (17934 bytes). The Manager imports it when adding the application or refreshing its monitoring files.

Generation prompt:

> Use case: logo-brand. Asset type: square application icon for Emberwatch, a fantasy tower-defense game, displayed at 124 × 124 pixels. Create an original polished raster game emblem: one bold stone watchtower with crenellations and a glowing amber ember-flame above its crown. Dark forest-green background (#192c27), warm gold (#efbb68) edges, deep green stone shadows. Stylized sculpted illustration with restrained dimensional shading, strong silhouette, broad clean shapes and very few details. Center the tower, filling about 80 percent of the square with generous safe margins. Full-bleed solid dark-green square background, no transparency. The tower and flame must remain immediately readable at small icon sizes. No words, letters, numbers, watermark, landscape, additional buildings or decorative outer frame. Deliver a square PNG.
